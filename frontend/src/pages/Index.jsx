    ...
    <div className='bg-[#18191b] min-h-screen w-full'>
        <div className={`w-screen ${show ? 'visible opacity-100' : 'invisible opacity-30'} transition-all duration-500 h-screen fixed bg-[#252627ad] flex justify-center items-center`}>
            <div className='w-[350px] bg-[#323335] m-auto px-6 py-4 roinded-md  relative'>
                <div onClick={()=>setShow(false)} className='absolute right-4 top-4 text-url cursor-pointer text-white'><IoMdClose/></div>
                <h2 className='text-white pb-4 text-center text-xl'>Login or SignUp in seconds</h2>
                {
                    type === 'login' && <form>
                    <div className='flex flex-col gap-3 mb-3 text-white'>
                        <label htmlFor="email">Email</label>
                        <input type="email" name='email' id='email' placeholder='email'
                        value={state.email} className='px-3 py-2 rounded-md border outline-none
                        border-[#5c5c5e] focus:border-purple-500 bg-transparent' />
                    </div>
                    <div className='flex flex-col gap-3 mb-3 text-white'>
                        <label htmlFor="password">Password</label>
                        <input type="password" name='password' id='password' placeholder='password'
                        value={state.password} className='px-3 py-2 rounded-md border outline-none
                        border-[#5c5c5e] focus:border-purple-500 bg-transparent' />
                    </div>
                    <div>
                            <button className='px-3 py-2 rounded-md bg-purple-500 w-full
                            ounline-none hover:bg-purple-600 text-white'>Sign in</button>
                        </div>
                    ...
                    <div className='pb-4'>
                        <button className='px-3 flex justify-center items-center gap-2 py-2
                        rounded-md bg-orange-700 w-full text-white outline-none 
                        hover:bg-orange-800'>
                    ...
                    <div >
                        <button className='px-3 flex justify-center items-center gap-2 py-2
                        rounded-md bg-blue-700 w-full text-white outline-none 
                        hover:bg-blue-800'>
                ...
                }
                {
                    ...
                    <div className='flex flex-col gap-3 mb-3 text-white'>
                        ...
                        value={state.name} className='px-3 py-2 rounded-md border outline-none
                        border-[#5c5c5e] focus:border-purple-500 bg-transparent' />
                    </div>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className='flex gap-4'>
                        <button onClick={() => {
                            setType("login")
                            setShow(true)
                            }} className='py-2 w-[80px] text-center bg-blue-500 text-white transition-all hover:bg-blue-600 rounded-[5px] font-medium'>Log in</button>
                        <button onClick={() => {
                                setType("signup")
                                setShow(true)
        ...
        <div className='w-full h-full justify-center items-center p-4'>
            <div className='py-[168px] flex justify-center items-center flex-col gap-6'>
               ...
               <button onClick={() => {
                                setType("signup")
                                setShow(true)
                             }}  className='py-2 w-[180px] text-center bg-purple-500 text-white transition-all hover:bg-purple-600 rounded-[5px] font-medium'>Signup for free</button>
            </div>
        </div>
